...
children_signif_prof<-children_z_score[c(4,5,6,9,10),] # finally we select the 5 motifs we are analysing
...
save(dom_mat_SP_df_long_children,file="dom_mat_SP_df_long_children_not_strict.Rdata")
save(dom_mat_SP_df_children,file="dom_mat_SP_df_children_not_strict.Rdata")
