...
# Load data
load(file="combined_dom_mat_SP.Rdata")
...
groups_info <- c(expression(paste("Other (", italic("n"), " = 48)")),
                 expression(paste("Social insects (Hymenoptera, ", italic("n"), " = 16)")),
                 ...
                 expression(paste("Ungulates (Artiodactyla, ", italic("n"), " = 37)")),
                 expression(paste("Non-human primates (Primates, ", italic("n"), " = 78)")),
...
ggsave(tpm_group_plot, device = "eps" ,filename="Global_tpm_plot.eps",width = 15, height=10, units = "cm", dpi = 900)
ggsave(tpm_group_plot, device = "jpeg" ,filename="Global_tpm_plot.jpeg",width = 15, height=10, units = "cm", dpi = 900)
...
# save plot
ggsave(norm_z_score_group_plot, device = "eps" ,filename="Global_SP_plot.eps",width = 25, height=10, units = "cm", dpi = 900)
ggsave(norm_z_score_group_plot, device = "jpeg" ,filename="Global_SP_plot.jpeg",width = 25, height=10, units = "cm", dpi = 900)
