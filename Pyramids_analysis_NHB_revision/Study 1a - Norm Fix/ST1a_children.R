...
# norm_factor<-apply(children_z_score[1:16,]^2,1,function(x) sqrt(sum(x,na.rm=T))) # calculate sqrt of SS
# children_signif_prof<-children_z_score[1:16,] * (1/norm_factor)
