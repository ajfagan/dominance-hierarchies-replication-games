...
# Load data
load(file="combined_dom_mat_SP_strict.Rdata")
...
combined_dom_mat_SP$Group = recode(combined_dom_mat_SP$Group, Accipitriformes = "Other", Anseriformes = "Other", Carcharhiniformes = "Other", 
         ...
         Rodentia= "Rodents (Rodentia)", Columbiformes = "Other")
...
groups_info <- c(expression(paste("Other (", italic("n"), " = 57)")),
                 expression(paste("Social insects (Hymenoptera, ", italic("n"), " = 18)")),
                 expression(paste("Birds (Passeriformes, ", italic("n"), " = 31)")),
                 expression(paste("Rodents (Rodentia, ", italic("n"), " = 57)")),
                 expression(paste("Carnivores (Carnivora, ", italic("n"), " = 32)")),
                 expression(paste("Ungulates (Artiodactyla, ", italic("n"), " = 40)")),
                 expression(paste("Non-human primates (Primates, ", italic("n"), " = 87)")),
...
ggsave(tpm_group_plot, device = "eps" ,filename="Global_tpm_plot_strict.eps",width = 15, height=10, units = "cm", dpi = 900)
ggsave(tpm_group_plot, device = "jpg" ,filename="Global_tpm_plot_strict.jpg",width = 15, height=10, units = "cm", dpi = 900)
...
# save plot
ggsave(norm_z_score_group_plot, device = "eps" ,filename="Global_SP_plot_strict.eps",width = 25, height=10, units = "cm", dpi = 900)
ggsave(norm_z_score_group_plot, device = "jpg" ,filename="Global_SP_plot_strict.jpg",width = 25, height=10, units = "cm", dpi = 900)
