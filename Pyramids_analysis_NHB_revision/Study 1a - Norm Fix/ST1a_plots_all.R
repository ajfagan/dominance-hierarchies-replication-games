...
# Load data
load(file="combined_dom_mat_SP_all.Rdata")
...
combined_dom_mat_SP$Group = recode(combined_dom_mat_SP$Group, Accipitriformes = "Other", Anseriformes = "Other", Carcharhiniformes = "Other", 
         ...
         Rodentia= "Rodents (Rodentia)", Columbiformes = "Other", Falconiformes = "Other",
         Octopoda = "Other", Perciformes = "Other")
...
groups_info <- c(expression(paste("Other (", italic("n"), " = 68)")),
                 expression(paste("Social insects (Hymenoptera, ", italic("n"), " = 19)")),
                 expression(paste("Birds (Passeriformes, ", italic("n"), " = 49)")),
                 expression(paste("Rodents (Rodentia, ", italic("n"), " = 59)")),
                 expression(paste("Carnivores (Carnivora, ", italic("n"), " = 34)")),
                 expression(paste("Ungulates (Artiodactyla, ", italic("n"), " = 45)")),
                 expression(paste("Non-human primates (Primates, ", italic("n"), " = 93)")),
...
ggsave(tpm_group_plot, device = "eps" ,filename="Global_tpm_plot_all.eps",width = 15, height=10, units = "cm", dpi = 900)
ggsave(tpm_group_plot, device = "jpg" ,filename="Global_tpm_plot_all.jpg",width = 15, height=10, units = "cm", dpi = 900)
...
# save plot
ggsave(norm_z_score_group_plot, device = "eps" ,filename="Global_SP_plot_all.eps",width = 25, height=10, units = "cm", dpi = 900)
ggsave(norm_z_score_group_plot, device = "jpg" ,filename="Global_SP_plot_all.jpg",width = 25, height=10, units = "cm", dpi = 900)
