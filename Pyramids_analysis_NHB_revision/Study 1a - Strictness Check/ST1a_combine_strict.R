...
# load CHILDREN data
load(file="dom_mat_SP_df_long_children.Rdata")
load(file="dom_mat_SP_df_children.Rdata")

# load ANIMAL data
load(file="dom_mat_SP_df_long_animals_strict.Rdata")
load(file="dom_mat_SP_df_animals_strict.Rdata")
...
save(combined_dom_mat_SP,file="combined_dom_mat_SP_strict.Rdata")
