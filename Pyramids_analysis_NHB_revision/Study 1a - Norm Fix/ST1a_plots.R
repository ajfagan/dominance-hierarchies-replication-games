...
ggsave(tpm_group_plot, device = "jpg" ,filename="Global_tpm_plot.jpg",width = 15, height=10, units = "cm", dpi = 900)
...
ggsave(norm_z_score_group_plot, device = "jpg" ,filename="Global_SP_plot.jpg",width = 25, height=10, units = "cm", dpi = 900)
